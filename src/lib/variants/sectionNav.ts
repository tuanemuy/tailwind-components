...
export const sectionNavVariants = cva("flex", {
  variants: {
    variant: {
...
export const sectionNavItemVariants = cva(
  "inline-flex items-center justify-center font-medium transition-colors focus:outline-none focus:ring-2 focus:ring-ring focus:ring-offset-2 disabled:opacity-50 disabled:pointer-events-none whitespace-nowrap",
  {
    variants: {
      variant: {
        underline:
          "px-4 py-2 border-b-2 border-transparent text-muted-foreground hover:text-foreground data-[active=true]:border-primary data-[active=true]:text-foreground -mb-px",
        pills:
          "px-4 py-2 rounded-md text-muted-foreground hover:text-foreground hover:bg-muted data-[active=true]:bg-primary data-[active=true]:text-primary-foreground",
        segment:
          "px-4 py-1.5 rounded-md text-muted-foreground data-[active=true]:bg-background data-[active=true]:text-foreground data-[active=true]:shadow-sm",
        bordered:
          "px-4 py-2 border-b-2 border-transparent text-muted-foreground hover:text-foreground hover:border-muted data-[active=true]:border-primary data-[active=true]:text-foreground -mb-0.5",
      },
      size: {
...
export const cardNavVariants = cva("grid", {
  variants: {
    columns: {
      2: "grid-cols-2",
      3: "grid-cols-3",
