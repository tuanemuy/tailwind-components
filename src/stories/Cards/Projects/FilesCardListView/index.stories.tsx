...
import { FilesCardListView } from "./index";
import type { FileCardItem } from "./index";

const meta: Meta<typeof FilesCardListView> = {
  title: "Cards/Projects/FilesCardListView",
  component: FilesCardListView,
  parameters: {
    layout: "padded",
  },
  tags: ["autodocs"],
...
const FileActionButtons = ({
  ...
  <div className="p-0.5 sm:p-1 inline-flex items-center gap-0.5 bg-card border border-border lg:shadow-xs rounded-lg">
    <button
      type="button"
    ...
    items: [
      {
        id: "1",
        type: "image",
        imageSrc: "https://images.unsplash.com/photo-1635776062360-af423602aff3?w=180&h=180&fit=crop",
