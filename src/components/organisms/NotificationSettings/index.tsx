...
import { MailIcon, BellIcon, SmartphoneIcon } from "@/lib/icons";
...
export interface NotificationSettingsProps
  ...
  onChannelChange?: (id: string, channel: "email" | "push" | "sms", enabled: boolean) => void;
  showChannels?: boolean;
}

export const NotificationSettings = forwardRef<HTMLDivElement, NotificationSettingsProps>(
  (
    {
      className,
      variant = "default",
...
interface NotificationSettingRowProps
  ...
  onChannelToggle?: (channel: "email" | "push" | "sms", enabled: boolean) => void;
}
...
export interface GroupedNotificationSettingsProps
  ...
  onSettingChange?: (groupId: string, settingId: string, enabled: boolean) => void;
  showChannels?: boolean;
  onChannelChange?: (
    groupId: string,
    settingId: string,
...
>(({ className, groups, onSettingChange, showChannels, onChannelChange, ...props }, ref) => {
  return (
              ...
              {group.settings.map((setting) => (
                ...
                >
                  ...
                  <Switch
                    checked={setting.enabled}
                    onChange={(e) =>
                      onSettingChange?.(group.id, setting.id, e.target.checked)
                    }
                  />
                </div>
              ))}
...
>(({ className, icon, title, description, enabled, onToggle, ...props }, ref) => {
  return (
    <div
      ref={ref}
      className={cn(
...
export interface EmailDigestSettingsProps
  ...
  onFrequencyChange?: (frequency: "daily" | "weekly" | "monthly" | "never") => void;
}

export const EmailDigestSettings = forwardRef<HTMLDivElement, EmailDigestSettingsProps>(
  ({ className, frequency, onFrequencyChange, ...props }, ref) => {
    const options = [
      ...
      { value: "monthly", label: "Monthly", description: "Receive a summary every month" },
      { value: "never", label: "Never", description: "Don't receive email digests" },
    ] as const;
