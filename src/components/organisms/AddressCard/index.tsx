...
import { MapPinIcon, EditIcon, TrashIcon, CheckIcon, HomeIcon, BuildingIcon } from "@/lib/icons";
...
const typeConfig: Record<AddressType, { label: string; icon: React.FC<{ className?: string }> }> = {
...
export interface AddressCardProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "onSelect"> {
  address: AddressData;
...
export interface AddressCardListProps extends Omit<React.HTMLAttributes<HTMLDivElement>, "onSelect"> {
