...
import { CompleteTheLook, ShopTheLook, type LookItem } from "./index";
...
export const Default: Story = {
  args: {
    ...
    mainImage: "https://images.unsplash.com/photo-1483985988355-763728e1935b?w=600&h=800&fit=crop",
...
export const HorizontalVariant: Story = {
  args: {
    ...
    mainImage: "https://images.unsplash.com/photo-1509631179647-0177331693ae?w=600&h=800&fit=crop",
...
export const AllSelected: Story = {
  args: {
    ...
    mainImage: "https://images.unsplash.com/photo-1485968579169-a6b577554be0?w=600&h=800&fit=crop",
    items: sampleItems.map((item) => ({ ...item, selected: true, inStock: true })),
    showTotalPrice: true,
    onItemSelect: (id, selected) => console.log("Item select:", id, selected),
    onAddAllToCart: (items) => console.log("Add to cart:", items),
  },
  ...
  render: () => (
    <ShopTheLook
      ...
      looks={[
        ...
        {
          id: "look3",
          image: "https://images.unsplash.com/photo-1485968579169-a6b577554be0?w=400&h=600&fit=crop",
