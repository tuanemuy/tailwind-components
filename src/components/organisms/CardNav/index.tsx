...
import { cardNavVariants, cardNavItemVariants } from "@/lib/variants/sectionNav";
  ...
  (
    ...
    return (
      <button
        ...
        className={cn(cardNavItemVariants({ variant, active: isActive }), className)}
        {...props}
      >
        {badge && (
        ...
        {icon && (
          <div className="mb-3 size-10 text-primary">
            {icon}
          </div>
        )}
...
export const HorizontalCardNav = forwardRef<HTMLDivElement, HorizontalCardNavProps>(
  (
    {
      className,
      scrollable = false,
          ...
          return (
            <button
              ...
              className={cn(
                ...
                variant === "default" && "border-border bg-card hover:border-primary",
                variant === "outlined" && "border-border bg-transparent hover:bg-muted/50",
...
export const FeatureSelection = forwardRef<HTMLDivElement, FeatureSelectionProps>(
