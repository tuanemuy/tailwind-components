...
import { TicketsLayout, KanbanTicketsLayout, type Ticket } from "./index";
...
const sampleTickets: Ticket[] = [
  {
    ...
    description: "User reports that they cannot access the dashboard after the recent update. Getting a 403 error.",
    status: "open",
    priority: "high",
    category: "Bug",
    customer: {
  ...
  },
  {
    ...
    description: "Customer requests dark mode support for better visibility during night work.",
    status: "in_progress",
    priority: "medium",
  ...
  },
  {
    ...
    description: "Multiple customers reporting failed transactions with error code E-500.",
    status: "open",
    priority: "urgent",
    category: "Bug",
    customer: {
  ...
  },
  {
    ...
    description: "The API documentation is outdated and missing new endpoints from v2.0.",
    status: "pending",
    priority: "low",
  ...
  },
  {
    ...
    description: "iOS app crashes immediately after splash screen on iPhone 15 Pro.",
    status: "resolved",
    priority: "high",
    category: "Bug",
    customer: {
...
export const FilteredByPriority: Story = {
  render: () => (
    <div className="h-[600px]">
      <TicketsLayout
        tickets={sampleTickets.filter((t) => t.priority === "high" || t.priority === "urgent")}
        activePriority="high"
        showSidebar={true}
        onSelectTicket={(id) => console.log("Select:", id)}
