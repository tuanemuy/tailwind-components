...
import { PlusIcon, MoreHorizontalIcon, ChevronDownIcon } from "@/lib/icons";

export interface KanbanGroupHeadingProps extends React.HTMLAttributes<HTMLDivElement> {
  title: string;
  count?: number;
  color?: string;
...
export const KanbanGroupHeading = forwardRef<HTMLDivElement, KanbanGroupHeadingProps>(
  (
    {
      className,
      title,
...
export interface MinimalKanbanHeadingProps extends Omit<KanbanGroupHeadingProps, "color" | "icon"> {
  dotColor?: string;
}

export const MinimalKanbanHeading = forwardRef<HTMLDivElement, MinimalKanbanHeadingProps>(
...
export const DraggableKanbanHeading = forwardRef<HTMLDivElement, DraggableKanbanHeadingProps>(
