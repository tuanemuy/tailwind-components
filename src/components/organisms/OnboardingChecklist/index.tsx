...
export const CompactChecklist = forwardRef<HTMLDivElement, CompactChecklistProps>(
...
export const ExpandableChecklist = forwardRef<HTMLDivElement, ExpandableChecklistProps>(
...
export const GamifiedChecklist = forwardRef<HTMLDivElement, GamifiedChecklistProps>(
  ({ className, title, items, onItemToggle, reward, ...props }, ref) => {
    ...
    return (
      ...
      >
        ...
        <div className={cn(
          "p-4",
          isComplete ? "bg-success/10" : "bg-gradient-to-r from-primary/5 to-transparent"
        )}>
          ...
          <div className="mt-3">
            <div className="flex items-center justify-between text-xs mb-1">
              <span className="font-medium">{completedCount}/{items.length} tasks</span>
              <span className={cn(isComplete ? "text-success" : "text-muted-foreground")}>
                {Math.round(progress)}%
              </span>
            </div>
