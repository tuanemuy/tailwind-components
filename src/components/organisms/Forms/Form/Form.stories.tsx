...
export const CardVariant: Story = {
  render: () => (
    ...
    >
      ...
      />
      <FormBody>
        <FormField label="Vendor" inputProps={{ placeholder: "eg. Nike" }} />
        <Select
          options={[
      ...
      <FormBody>
        ...
        <FormSection title="Address" description="Enter your shipping address">
          ...
          <FormRow>
            ...
            <FormField
              label="Country"
              inputProps={{ placeholder: "United States" }}
            />
          </FormRow>
        </FormSection>
      </FormBody>
    ...
    >
      ...
      <FormBody columns={2} gap="md">
        <FormField
          label="Product Name"
          required
          inputProps={{ placeholder: "Enter product name" }}
        />
        ...
        <FormSection>
          <div className="space-y-3">
            <label
              ...
              className="flex items-start gap-3 p-3 rounded-lg border border-border cursor-pointer hover:bg-accent/50 has-[:checked]:border-primary has-[:checked]:bg-primary/5"
            >
              <Radio
...
export const Disabled: Story = {
  render: () => (
    ...
    >
      ...
      <FormActions bordered>
        <SubmitButton loading loadingText="Processing...">
          Submit
        </SubmitButton>
      </FormActions>
    </Form>
      ...
      <FormBody>
        ...
        <div className="grid grid-cols-2 gap-3">
          <Button variant="outline" className="w-full">
            <svg aria-hidden="true" className="size-5 mr-2" viewBox="0 0 24 24">
              <path
                fill="currentColor"
