...
const features = [
  ...
  },
  {
    ...
    title: "Global Scale",
    description: "Deploy globally with our distributed infrastructure and CDN integration.",
  },
  {
    id: "5",
  ...
  },
  {
    ...
    description: "Lightning-fast load times with optimized performance and lazy loading.",
  },
];
        ...
        <FeatureListItem>
          <FeatureListContent>
            ...
            <FeatureCardDescription className="text-base">
              ...
              Our comprehensive API and SDK make integration seamless,
              whether you&apos;re using React, Vue, or vanilla JavaScript.
            </FeatureCardDescription>
        ...
        <FeatureListItem reverse>
          <FeatureListContent>
            ...
            <FeatureCardDescription className="text-base">
              ...
              Shared workspaces, comments, and version history
              make working together effortless.
            </FeatureCardDescription>
            <FeatureCardLink href="#">Learn about collaboration</FeatureCardLink>
          </FeatureListContent>
          <FeatureListImage
      ...
      <FeatureGrid columns={3} gap="lg">
        {features.slice(0, 3).map((feature) => (
          <div key={feature.id} className="text-center">
            ...
            <FeatureCardTitle className="text-base">{feature.title}</FeatureCardTitle>
            <FeatureCardDescription>{feature.description}</FeatureCardDescription>
          </div>
        ))}
      </FeatureGrid>
...
export const WithBackgroundColor: Story = {
  render: () => (
    <FeatureSection className="bg-muted/50">
      ...
      <FeatureGrid columns={3}>
        {features.map((feature) => (
          <FeatureCard key={feature.id} variant="default" className="bg-background">
            <FeatureCardIcon className="mb-4">{feature.icon}</FeatureCardIcon>
            <FeatureCardTitle>{feature.title}</FeatureCardTitle>
            <FeatureCardDescription>{feature.description}</FeatureCardDescription>
          </FeatureCard>
