...
export const FeatureSection = forwardRef<HTMLElement, FeatureSectionProps>(
  ({ className, variant = "grid", columns = 3, padding = "lg", children, ...props }, ref) => {
    return (
      <section
        ref={ref}
...
export interface FeatureSectionHeaderProps extends React.HTMLAttributes<HTMLDivElement> {
  align?: "left" | "center";
}

export const FeatureSectionHeader = forwardRef<HTMLDivElement, FeatureSectionHeaderProps>(
...
export interface FeatureSectionTitleProps extends React.HTMLAttributes<HTMLHeadingElement> {
  as?: "h2" | "h3";
}

export const FeatureSectionTitle = forwardRef<HTMLHeadingElement, FeatureSectionTitleProps>(
...
export interface FeatureSectionSubtitleProps extends React.HTMLAttributes<HTMLParagraphElement> {}

export const FeatureSectionSubtitle = forwardRef<HTMLParagraphElement, FeatureSectionSubtitleProps>(
...
export const FeatureCard = forwardRef<HTMLDivElement, FeatureCardProps>(
  ({ className, variant = "bordered", iconPosition = "top", children, ...props }, ref) => {
    return (
      <div
        ref={ref}
        className={cn(
...
export interface FeatureCardIconProps extends React.HTMLAttributes<HTMLDivElement> {
...
export interface FeatureCardContentProps extends React.HTMLAttributes<HTMLDivElement> {}

export const FeatureCardContent = forwardRef<HTMLDivElement, FeatureCardContentProps>(
  ({ className, children, ...props }, ref) => {
    return (
...
export interface FeatureCardTitleProps extends React.HTMLAttributes<HTMLHeadingElement> {
  as?: "h3" | "h4";
}

export const FeatureCardTitle = forwardRef<HTMLHeadingElement, FeatureCardTitleProps>(
...
export interface FeatureCardDescriptionProps extends React.HTMLAttributes<HTMLParagraphElement> {}

export const FeatureCardDescription = forwardRef<HTMLParagraphElement, FeatureCardDescriptionProps>(
  ({ className, children, ...props }, ref) => {
    return (
...
export interface FeatureCardLinkProps extends React.AnchorHTMLAttributes<HTMLAnchorElement> {}

export const FeatureCardLink = forwardRef<HTMLAnchorElement, FeatureCardLinkProps>(
  ({ className, children, ...props }, ref) => {
    return (
      <a
        ref={ref}
...
export interface FeatureListContentProps extends React.HTMLAttributes<HTMLDivElement> {}

export const FeatureListContent = forwardRef<HTMLDivElement, FeatureListContentProps>(
  ({ className, children, ...props }, ref) => {
    return (
...
export interface FeatureListImageProps extends React.HTMLAttributes<HTMLDivElement> {
  src: string;
  alt: string;
}

export const FeatureListImage = forwardRef<HTMLDivElement, FeatureListImageProps>(
