...
export const Default: Story = {
  render: () => (
    <Footer
      logo={<FooterLogo href="#" text="Acme Inc" />}
      copyright="© 2024 Acme Inc. All rights reserved."
      socialLinks={
        <>
          <FooterSocialLink href="#" icon={<TwitterIcon />} label="Twitter" />
          <FooterSocialLink href="#" icon={<GitHubIcon />} label="GitHub" />
          <FooterSocialLink href="#" icon={<LinkedInIcon />} label="LinkedIn" />
        </>
      }
      legalLinks={
        <>
    ...
    <Footer variant="bordered">
      <FooterGrid columns={5}>
        <div className="col-span-2">
          <FooterLogo href="#" text="Company Name" />
  ...
  render: () => (
    <Footer variant="stacked">
      <div className="text-center space-y-6">
        <FooterLogo href="#" text="Centered Logo" className="justify-center" />
  ...
  render: () => (
    <Footer variant="bordered">
      <FooterGrid columns={4}>
        <div>
          <FooterLogo href="#" text="Newsletter" />
